...
for (const file of ['index.html', 'wiki.html', 'changelog.html', 'prompts.html', 'admin.html', 'styles', 'admin', 'vendor', 'data', 'favicon.svg', 'new-favicon.png', 'avatar.webp', 'og.jpg', 'Logo Black.svg', 'content.js', 'portfolio-content.js', 'script.js', 'content-sync.js', 'chrome.js', 'favicons.js', 'intro.js', 'mail.js', 'cmd.mjs', 'prompts.mjs', 'portfolio.mjs', 'contrib.mjs', 'cursor.mjs', 'sound.mjs', 'scroll.mjs']) await cp(path.join(root, file), path.join(out, file), { recursive: true, filter: source => path.basename(source) !== '.DS_Store' });
