...
const LABELS = { name: 'Título', title: 'Título', role: 'Subtítulo', summary: 'Resumo na home', bio: 'Descrição do modal', items: 'Destaques', links: 'Links', preview: 'Imagem de capa', faviconFrom: 'Site do ícone', subprojects: 'Subprojetos', gallery: 'Galeria do projeto', sections: 'Seções do modal', label: 'Nome da seção', text: 'Texto', list: 'Lista', entries: 'Conteúdos', people: 'Pessoas vinculadas', ref: 'Identificador da pessoa', what: 'Descrição curta', url: 'URL', href: 'URL', src: 'Imagem', alt: 'Descrição da imagem', caption: 'Legenda', width: 'Largura em pixels', height: 'Altura em pixels', description: 'Descrição', category: 'Categoria', tags: 'Tags', prompt: 'Texto do prompt' };
const MULTILINE = new Set(['bio', 'prompt', 'text', 'description', 'what']);
const TEMPLATES = { links: ['', 'https://'], items: '', tags: '', bio: '', list: '', sections: { label: '', text: '', list: [], entries: [], people: [] }, subprojects: { name: '', url: 'https://', preview: '', description: '' }, gallery: { src: '', alt: '', caption: '' }, entries: { name: '', role: '', what: '', links: [] }, people: { ref: '' } };
