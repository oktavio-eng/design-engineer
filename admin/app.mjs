...
function edit(collection, key) {
  ...
  dialog.querySelectorAll('[data-add-field]').forEach(button => button.onclick = () => { const field = button.dataset.addField; if (!Object.hasOwn(entry, field)) { entry[field] = ['preview', 'faviconFrom', 'summary'].includes(field) ? '' : []; paintFields(); } });
