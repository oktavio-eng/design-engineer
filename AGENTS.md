...
- `.extras` / `.see-more`: Enter e Space, foco preservado, classe `expanded` e texto show more/show less; `aria-expanded`/`aria-controls` entram na story somente depois de existirem na produção.
