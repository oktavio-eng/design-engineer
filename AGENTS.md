...
- Validado em Chrome real via CDP: 207/207 elementos de texto em 17.6px/460, Geist confirmada como renderizada (`document.fonts.check`, e não só declarada), sem overflow horizontal no mobile.
