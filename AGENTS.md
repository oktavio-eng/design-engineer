...
- A conta do total: 5 palavras não-finais (Hola, Bonjour, Olá, こんにちは, 你好) a `2×--intro-fade + --intro-hold` (200+200+120 = 520ms) cada = 2.6s, mais "Hello" a `2×--intro-fade + --intro-hold-last` (200+200+1000 = 1.4s), mais a marca a `--intro-reveal + --intro-mark-hold` (400+150 = 550ms). Total ≈ 4.55s até liberar o conteúdo, mais os 500ms de `--intro-out` (que já rodam em cross-fade com o stagger) até o overlay sair do DOM.
